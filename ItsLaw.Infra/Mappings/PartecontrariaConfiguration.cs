...
namespace ItsLaw.Infra.Mappings
{
    ...
    public partial class ParteContrariaConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ParteContraria>
    {
        public ParteContrariaConfiguration()
            : this("dbo")
        {
        }

        public ParteContrariaConfiguration(string schema)
        {
            ToTable("PARTECONTRARIA", schema);
            HasKey(x => x.IdParteContraria);

            Property(x => x.IdParteContraria         ).HasColumnName(@"IDPARTECONTRARIA"     ).HasColumnType("int"     ).IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
