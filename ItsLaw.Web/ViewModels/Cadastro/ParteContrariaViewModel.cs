...
namespace ItsLaw.Web.ViewModels
{
    ...
    public class ParteContrariaViewModel
    {
        public ParteContrariaViewModel()
        {

        }

        public ParteContrariaViewModel(ParteContraria Itens)
        {
            IdParteContraria      = Itens.IdParteContraria;
        ...
        public ParteContraria ToDomain()
        {
            var Itens = new ParteContraria();

            Itens.IdParteContraria      = IdParteContraria;
        ...
        [Display(Name = "Nome")]
        [Required(ErrorMessage = "Informe o Nome da Parte Contrária", AllowEmptyStrings = false)]
