...
namespace ItsLaw.Web.ViewModels
{
    ...
    public class TestemunhaViewModel
    {
        public TestemunhaViewModel()
        {

        }

        public TestemunhaViewModel(Testemunha Itens)
        {
            IdTestemunha          = Itens.IdTestemunha;
        ...
        public Testemunha ToDomain()
        {
            var Itens = new Testemunha();

            Itens.IdTestemunha          = IdTestemunha;
        ...
        [Required(ErrorMessage = "Informe o CPF ou CNPJ da Testemunha", AllowEmptyStrings = false)]
        [CpfCnpj(ErrorMessage  = "O valor é inválido para CPF ou CNPJ" )]
        [Display(Name = "CPF/CNPJ")]
        public string CpfCnpj                    { get; set; }

        [Display(Name = "Nome")]
        [Required(ErrorMessage = "Informe o Nome da Testemunha", AllowEmptyStrings = false)]
